        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistritationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3e4d4952-f56f-2239-2499-a4fae4bb5059"), "Noemi.Walter20@gmail.com", "Noemi", "Walter" },
                    { new Guid("72f98826-90f8-1296-34a2-df213eea8382"), "Alan80@yahoo.com", "Alan", "Schowalter" },
                    { new Guid("7d9d849b-3fe5-eee4-f124-cc4bfc29cc4d"), "Wyman_Sauer@yahoo.com", "Wyman", "Sauer" },
                    { new Guid("851b00b0-4067-b3d2-86eb-2c60addfbca4"), "Clarissa.Schamberger@yahoo.com", "Clarissa", "Schamberger" },
                    { new Guid("ea9f386a-4a4e-a90f-0675-d73ba4897821"), "Hassie69@hotmail.com", "Hassie", "Yost" }
                });

            migrationBuilder.InsertData(
                table: "Vehicles",
                columns: new[] { "VehicleId", "Color", "Fuel", "Manufacturer", "Model", "OrderId", "RegistritationDate", "TopSpeed", "Type" },
                values: new object[,]
                {
